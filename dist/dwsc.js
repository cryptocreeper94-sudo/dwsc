    ...
    dom.create("div", { className: "highlight-card reveal", children: [
      ...
      dom.create("div", { className: "highlight-stats", children: [
        dom.create("div", { className: "highlight-stat", children: [
          dom.create("div", { className: "stat-val gradient-text", text: "v1.0.5" }),
          dom.create("div", { className: "stat-lbl", text: "Latest Version" })
        ]}),
        dom.create("div", { className: "highlight-stat", children: [
          dom.create("div", { className: "stat-val gradient-text", text: "154" }),
          dom.create("div", { className: "stat-lbl", text: "Intent Patterns" })
        ]}),
        dom.create("div", { className: "highlight-stat", children: [
          dom.create("div", { className: "stat-val gradient-text", text: "529" }),
